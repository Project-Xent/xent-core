...
int main(void) {
    ...
    xent_set_size(ctx, root, 800.0f, 600.0f);
    xent_set_gap(ctx, root, 8.0f);
    xent_set_padding(ctx, root, 8.0f, 8.0f, 8.0f, 8.0f);

    xent_set_size(ctx, sidebar, 200.0f, 580.0f);
    ...
    xent_set_size(ctx, toolbar, NAN, 48.0f);
    ...
    xent_set_size(ctx, text, NAN, NAN);
