...
int main(void) {
    ...
    xent_set_size(ctx, child, 50.0f, 50.0f);
    xent_set_size(ctx, child2, 50.0f, 50.0f);
    ...
    xent_set_size(ctx, child, 60.0f, 50.0f);
    ...
    xent_set_size(ctx, child, 70.0f, 50.0f);
    xent_set_size(ctx, child2, 70.0f, 50.0f);
    TEST_ASSERT(xent_layout(ctx, root, 200.0f, 80.0f));
    TEST_ASSERT(xent_get_last_layout_strategy(ctx) == XENT_LAYOUT_STRATEGY_FULL_TREE);
