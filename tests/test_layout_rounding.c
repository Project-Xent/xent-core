...
int main(void) {
    ...
    TEST_ASSERT(xent_set_size(ctx, root, 10.3f, 20.7f));
    TEST_ASSERT(xent_set_size(ctx, child, 3.26f, 4.74f));
    TEST_ASSERT(xent_set_absolute_position(ctx, child, 1.24f, 2.74f));
